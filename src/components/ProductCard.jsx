      ...
      <div className="px-5 pb-5 mt-3">
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <div className="flex space-x-2">
            <button className="px-4 py-2 text-xs font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition" onClick={()=>{
              addToCart(product)
            }}>
              Add to Cart
            </button>
